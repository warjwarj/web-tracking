...
function getDriverData(fleetdata, weightConfig, dname, range){ for (let i of fleetdata){ if (i.driver.trim() == dname) { return Scoring.getScoreDriver(i.driver, weightConfig); } } }
